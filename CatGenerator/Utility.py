...
def get_opt():
    ...
    parser.add_argument("--num_epochs_autoencoder", type=int, default=200, help="number of epochs of training for the autoencoder")
    ...
    parser.add_argument("--latent_size", type=int, default=2048, help="size of the latent vector i.e. size of decoder input")
    ...
    parser.add_argument("--min_feature_size", type=int, default=16, help="Smallest feature count for the conv layers (default 16)")
